...
def root():
    ...
    <html>
        ...
        <body style='font-family:Segoe UI,Arial,sans-serif;text-align:center;margin-top:10%;'>
            <h1 style='color:#2563eb;'>✅ Backend is running!</h1>
            <p>This is the AI Resume Screening API.<br>Use the <a href='/docs'>/docs</a> for API documentation.</p>
        </body>
    </html>
    """
